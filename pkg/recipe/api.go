...
type Recipe interface {
	GetName() string
	Discover(cfg *config.Config, versionQuery string) (url string, method string, err error)
	Parse(cfg *config.Config, data []byte, versionQuery string) ([]PackageDefinition, error)
}
...
func (r *GoRecipe) Discover(cfg *config.Config, versionQuery string) (string, string, error) {
	return r.DiscoveryURL, "GET", nil
}
func (r *GoRecipe) Parse(cfg *config.Config, data []byte, versionQuery string) ([]PackageDefinition, error) {
